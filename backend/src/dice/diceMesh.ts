...
/** d6 reads larger at the same bbox max-dim because a cube fills the box more than polyhedra. */
...
/** Face-marker samples for Rapier convex hull — true polyhedron without bevel-edge facets. */
